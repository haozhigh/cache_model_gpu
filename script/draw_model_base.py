...
def main():
    mod_records, mod_fields = get_records_from_csv('../output/miss_rate_model_base.csv')
    ...
    for suite in suites:
        ...
        draw_model_2c_compare(mod_r, mod_f, prof_r, prof_f, sim_r, sim_f, 'model_base_' + suite + '.png')
